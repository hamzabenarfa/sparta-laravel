...
<div class="row g-0 py-3">
    <div class="col-12 px-2">
        ...
        <form action="{{ route('frontend.profile.update.password') }}" method="POST" class="card card-form mx-auto my-4" id="formChangePassword">
            @csrf
            <div class="card-header bg-transparent border-0 p-0">
                <h1 class="h5 text-primary fw-bolder text-uppercase mb-3">@lang('web.change password.title')</h1>
            </div>
