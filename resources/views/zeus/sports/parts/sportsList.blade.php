...
<script type="text/javascript">
    ...
    function searchRequest(key) {
        ...
        $.ajax({
            url: "<?= route('frontend.zeus.sports.get_search') ?>",
            type: 'get',
            data: {
                key,
                isLive
    ...
    function getInitLeague() {
        $.ajax({
            url: "<?= route('frontend.zeus.sports.get_init_league') ?>",
            type: 'get',
            data: {
    ...
    function getEventData() {
        ...
        $.ajax({
            url: "<?= route('frontend.zeus.sports.get_event') ?>",
            type: 'get',
            data: {
                id
            }
            ...
            await makeEventMarket(data);
            $.ajax({
                url: "<?= route('frontend.zeus.sports.get_init_live') ?>",
                type: 'get',
                data: {
                    sport_id: '',
                    league_id: ''
